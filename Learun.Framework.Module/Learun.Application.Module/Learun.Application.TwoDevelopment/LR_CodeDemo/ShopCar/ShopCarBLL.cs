...
namespace Learun.Application.TwoDevelopment.LR_CodeDemo
{
    ...
    /// 描 述：购物车
    /// </summary>
    public class ShopCarBLL : ShopCarIBLL
    {
        ...
        public IEnumerable<CartItemEntity> GetListByUserId(string queryJson)
        {
            try
            {
                return shopCarService.GetListByUserId(queryJson);
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<CartItemEntity> GetList( string queryJson )
        {
            try
            {
                return shopCarService.GetList(queryJson);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public IEnumerable<CartItemEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return shopCarService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public CartItemEntity GetEntity(string keyValue)
        {
            try
            {
                return shopCarService.GetEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                shopCarService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntityByUserId(string keyValue)
        {
            try
            {
                shopCarService.DeleteEntityByUserId(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveEntity(string keyValue, CartItemEntity entity)
        {
            try
            {
                shopCarService.SaveEntity(keyValue, entity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
