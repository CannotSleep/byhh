...
namespace Learun.Application.TwoDevelopment.LR_CodeDemo
{
    ...
    /// 描 述：文章分类表
    /// </summary>
    public class ArticleCategoryBLL : ArticleCategoryIBLL
    {
        ...
        public IEnumerable<ArticleCategoryEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return articleCategoryService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<ArticleCategoryEntity> GetList(string queryJson)
        {
            try
            {
                return articleCategoryService.GetList(queryJson);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public ArticleCategoryEntity GetArticleCategoryEntity(string keyValue)
        {
            try
            {
                return articleCategoryService.GetArticleCategoryEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                articleCategoryService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveEntity(string keyValue, ArticleCategoryEntity entity)
        {
            try
            {
                articleCategoryService.SaveEntity(keyValue, entity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
