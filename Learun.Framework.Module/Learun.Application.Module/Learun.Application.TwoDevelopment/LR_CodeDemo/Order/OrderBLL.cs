...
namespace Learun.Application.TwoDevelopment.LR_CodeDemo
{
    ...
    /// 描 述：订单管理
    /// </summary>
    public class OrderBLL : OrderIBLL
    {
        ...
        public IEnumerable<ordersEntity> GetList( string queryJson )
        {
            try
            {
                return orderService.GetList(queryJson);
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<ordersEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return orderService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public ordersEntity GetEntity(string keyValue)
        {
            try
            {
                return orderService.GetEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public IEnumerable<ordersEntity> GetByUserId(string orderId, Pagination pagination)
        {
            try
            {
                return orderService.GetByUserId(orderId, pagination);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                orderService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveEntity(string keyValue, ordersEntity entity)
        {
            try
            {
                orderService.SaveEntity(keyValue, entity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
